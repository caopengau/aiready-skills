...
![The Hairball Pattern - A dense cluster of interconnected nodes](/hairball-pattern.jpg)
...
![The Orphans Pattern - Disconnected clusters of nodes](/orphans-pattern.jpg)
...
![The Butterflies Pattern - A central node with many connections](/butterflies-pattern.jpg)
...
<div style="max-width:720px;margin:1.5rem auto;text-align:center;">
  <img
    ...
    style="width:100%;border-radius:8px;box-shadow:0 10px 30px rgba(2,6,23,0.12);"
  />
...
6. **How** to _see_ the shape of your debt visually ← You are here

The natural next step is moving from _detection_ to _remediation_ — which is exactly what the AIReady Platform (currently in beta) is designed to do: auto-generated refactoring plans, trend tracking over time, and team-level benchmarks.
