...
const Post = () => (
  <>
    ...
    <p>
      ...
      are great for visualizing dependencies and spotting cycles, but they don’t
      answer the questions that matter for AI:
    </p>
    <ul>
    ...
    <div className="my-12 max-w-2xl mx-auto">
      ...
      <p className="text-center text-sm text-slate-500 mt-4 italic">
        The three metrics that actually matter for AI-ready codebases: semantic
        similarity, context budget, and consistency.
      </p>
    </div>
    ...
    <ul>
      <li>
        <strong>What it is:</strong> Finds code that does the same thing, even
        if it looks different.
      </li>
      <li>
        <strong>How:</strong> Uses Jaccard similarity on AST tokens to detect
        “semantic duplicates.”
      </li>
      <li>
        <strong>Why it matters:</strong> AI models waste context window on
        repeated logic, making suggestions less relevant and increasing
        maintenance cost.
      </li>
    </ul>
...
`}</CodeBlock>
    ...
    <ul>
      <li>
        <strong>What it is:</strong> Measures the “token cost” of understanding
        a feature or file.
      </li>
      <li>
        <strong>How:</strong> Analyzes import chains, file size, and
        fragmentation to estimate how much context an AI needs to answer a
        question about your code.
      </li>
      <li>
        <strong>Why it matters:</strong> The more fragmented your logic, the
        more tokens are needed—quickly exceeding the model’s window and leading
        to hallucinations or missed context.
      </li>
    </ul>
...
`}</CodeBlock>
    ...
    <ul>
      <li>
        <strong>What it is:</strong> Quantifies naming and pattern drift across
        your codebase.
      </li>
      <li>
        <strong>How:</strong> Tracks how often similar things are named or
        structured differently.
      </li>
      <li>
        <strong>Why it matters:</strong> Inconsistent code confuses both humans
        and AIs, reducing the quality of suggestions and increasing onboarding
        time.
      </li>
    </ul>
    ...
    <ul>
      <li>
        <code>getUserById</code>, <code>fetchUser</code>,{' '}
        <code>retrieveUser</code> — all for the same operation.
      </li>
    </ul>

    <h2>Hub-and-Spoke Architecture: Flexibility by Design</h2>
    <p>
      AIReady uses a <strong>hub-and-spoke</strong> model:
    </p>
    <ul>
      <li>
        <strong>Hub:</strong> Shared utilities, types, and the CLI interface.
      </li>
      <li>
        <strong>Spokes:</strong> Each metric is a focused tool (pattern-detect,
        context-analyzer, consistency), independently useful and pluggable.
      </li>
    </ul>
    <p>
      This makes it easy to add new metrics, customize for your team, and keep
      the core lean.
    </p>

    <h2>Smart Defaults: Focus on What Matters</h2>
    <p>
      By default, AIReady surfaces the ~10 most serious issues in each category.
      No more drowning in thousands of low-priority warnings—just the problems
      that will actually move the needle for your team.
    </p>
    ...
    <h2>Conclusion</h2>
    <p>
      If you’re still measuring code quality with tools built for humans, you’re
      missing the real blockers to AI productivity. AIReady gives you the
      metrics that actually matter—so you can build codebases that are ready for
      the future.
    </p>
