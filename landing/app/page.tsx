                ...
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-2xl border-2 border-blue-200">
                  ...
                  <ul className="space-y-3 text-slate-700">
                    <li className="flex items-start gap-2">
                      ...
                      <span><strong>Adjust weights</strong> for your priorities</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-blue-600 mt-1">✓</span>
                      <span><strong>Set thresholds</strong> for CI/CD gates</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-blue-600 mt-1">✓</span>
                      <span><strong>Scores stay comparable</strong> as new tools launch</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-blue-600 mt-1">✓</span>
                      <span><strong>New tools are opt-in</strong> – never forced</span>
                    </li>
                  </ul>
