  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-white mb-8 gradient-text">Privacy Policy</h1>
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6 text-slate-300">
          <section>
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>Account information: GitHub username, email, and profile data when you sign in</li>
              <li>Repository data: URLs and analysis results for repositories you track</li>
          ...
          <section>
            ...
            <p>We use essential cookies to authenticate users and maintain session state. We do not use tracking cookies or third-party analytics services that sell your data.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-3">8. Third-Party Services</h2>
            <p>Our service uses GitHub for authentication. Your use of GitHub is subject to GitHub's Privacy Policy. We only access basic profile information necessary for authentication.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-3">9. Children's Privacy</h2>
            <p>Our service is not directed to children under 13. We do not knowingly collect personal information from children under 13. If we become aware that we have collected personal information from a child under 13, we will take steps to delete such information.</p>
          </section>
