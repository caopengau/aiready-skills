...
import { RocketIcon, ChartIcon, TargetIcon, RobotIcon } from '@/components/Icons';
...
const features = [
  {
    ...
    title: 'Track Trends',
    description: 'Monitor AI readiness scores over time with detailed historical data and beautiful visualizations',
    gradient: 'from-blue-500 to-cyan-500',
  },
  {
    icon: <TargetIcon className="w-7 h-7 text-white" />,
    title: 'Benchmark',
    description: 'Compare your codebase against similar projects and industry standards',
    gradient: 'from-cyan-500 to-purple-500',
  },
  {
    icon: <RobotIcon className="w-7 h-7 text-white" />,
    title: 'AI Insights',
    description: 'Get actionable recommendations to improve AI comprehension and code quality',
  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-[#0a0a0f]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="orb orb-cyan w-80 h-80 top-1/4 -right-40" style={{ animationDelay: '2s' }} />
        <div className="orb orb-purple w-72 h-72 bottom-0 left-1/4" style={{ animationDelay: '4s' }} />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8">
        ...
        >
          ...
          >
            <span className="font-semibold text-white">Monitor, analyze, and improve your codebase AI readiness.</span>
            <br />
            <span className="text-cyan-400">Sign in to track multiple repositories and benchmark your progress.</span>
          </motion.p>
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <div className={`text-4xl mb-4 inline-block p-3 rounded-xl bg-gradient-to-br ${feature.gradient} bg-opacity-20`}>
                  {feature.icon}
                </div>
            ...
            <div className="glass-card rounded-2xl p-6 relative overflow-hidden">
              ...
              <div className="space-y-2 font-mono text-sm">
                ...
                >
                  ...
                  <div className="text-emerald-400">✓ Report saved to report.json</div>
                </motion.div>
              </div>
